...
fish_temp <- data.frame(
  ...
  `Optimal Temperature Range` = c("75–86°F (24–30°C)", "69.1-82.2°F (20.6-27.9°C)", "Not specified", "59 - 75.4°F (15 - 24.1°C)"),
  ...
  Source = c(
    ...
    "[Fish Base](https://www.fishbase.se/summary/SpeciesSummary.php?ID=13996&AT=Gulf+Croaker)",
    "[Fish Base](https://www.fishbase.se/summary/SpeciesSummary.php?ID=3582&AT=orangemouth+Corvina)",
    "[Fish Base](https://www.fishbase.se/summary/SpeciesSummary.php?ID=1753&AT=Sargo-leg%C3%ADtimo-do-Mediterr%C3%A2neo)"
  )
)
